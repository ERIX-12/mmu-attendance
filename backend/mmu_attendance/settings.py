"""
Django settings for mmu_attendance project.
...
ROOT_URLCONF = 'mmu_attendance.urls'
...
WSGI_APPLICATION = 'mmu_attendance.wsgi.application'
...
# CORS settings
CORS_ALLOW_ALL_ORIGINS = True  # Allow all origins to make integration seamless
...
DEFAULT_FROM_EMAIL = os.environ.get('DEFAULT_FROM_EMAIL', 'MMU Attendance <no-reply@mmu.ac.ug>')
